        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
          ...
          <div class="p-6 border-b border-gray-200">
            <div class="flex justify-between items-center">
              <div>
                <h3 class="text-lg font-medium text-gray-900">Gestión de Cupones</h3>
                <p class="mt-1 text-sm text-gray-600">
                  Administra los códigos de descuento del restaurante
                </p>
              </div>
              <Link
          ...
          <!-- Paginación -->
          <div v-if="coupons.data.length === 0" class="p-6 text-center text-gray-500">
